...
public abstract class Hilt_CharactersFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CharactersFragment() {
    super();
  }

  Hilt_CharactersFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CharactersFragment_GeneratedInjector) this.generatedComponent()).injectCharactersFragment(UnsafeCasts.<CharactersFragment>unsafeCast(this));
    }
  }
