...
public abstract class Hilt_CharacterDetailedFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CharacterDetailedFragment() {
    super();
  }

  Hilt_CharacterDetailedFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CharacterDetailedFragment_GeneratedInjector) this.generatedComponent()).injectCharacterDetailedFragment(UnsafeCasts.<CharacterDetailedFragment>unsafeCast(this));
    }
  }
